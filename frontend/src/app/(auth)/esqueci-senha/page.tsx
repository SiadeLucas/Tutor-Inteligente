        ...
        <div className="bg-white dark:bg-[#261d11] border border-slate-200/90 dark:border-[#3d2f1f] rounded-2xl p-7 sm:p-9 shadow-sm">
          {sucesso ? (
            <div className="text-center space-y-4">
              ...
              {sucesso.link_dev && (
                <div className="mt-4 p-3.5 bg-slate-50 dark:bg-[#1a1408] border border-slate-200 dark:border-[#3d2f1f] rounded-xl text-left">
                  <span className="text-[10px] font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400 block mb-1">
                    Atalho de Desenvolvimento Local:
                  </span>
                  <a
                    href={sucesso.link_dev}
                    className="text-xs text-[#E65100] dark:text-[#FFB74D] underline break-all hover:text-[#EF6C00]"
                  >
                    {sucesso.link_dev}
                  </a>
                </div>
              ...
              <div className="pt-3">
                <Link
                  href="/login"
                  className="w-full py-2.5 px-4 rounded-xl border border-slate-200 dark:border-[#3d2f1f] hover:bg-slate-50 dark:hover:bg-[#1a1408] text-slate-700 dark:text-slate-200 font-semibold text-xs transition-colors inline-flex items-center justify-center gap-1.5"
                >
