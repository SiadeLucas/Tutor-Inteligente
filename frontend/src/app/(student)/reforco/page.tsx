      ...
      <main className="flex-1 max-w-4xl w-full mx-auto px-4 py-8">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <h1 className="text-2xl font-black text-slate-900 dark:text-white flex items-center gap-2.5">
              <Inbox className="w-7 h-7 text-[#F57C00]" />
              Caixa de Reforço
            </h1>
          ...
          <div className="text-right">
            <span className="text-2xl font-black text-[#F57C00] font-mono">
              {itens.length}
            </span>
        ...
        {gemeaAtual && (
          <div className="mb-8">
            <div className="flex items-center justify-between mb-3">
              <h2 className="text-sm font-bold uppercase tracking-wider text-slate-500 dark:text-[#A89F91] flex items-center gap-2">
                <Sparkles className="w-4 h-4 text-purple-600" />
                Treino de Reforço — Questão Gêmea
              </h2>
              <button
                onClick={handleFecharPratica}
                className="text-xs font-semibold text-slate-500 hover:text-slate-900 dark:hover:text-white transition-colors px-3 py-1.5 rounded-lg hover:bg-slate-100 dark:hover:bg-[#332514]"
              >
        ...
        {loading ? (
          ...
          <div className="p-12 text-center bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-xs max-w-md mx-auto">
            ...
            <Link
              href="/materias"
              className="px-6 py-2.5 rounded-xl bg-[#F57C00] hover:bg-[#E65100] text-white font-bold text-sm shadow-sm transition-all inline-block"
            >
              ...
              >
                ...
                <div className="mt-4 pt-4 border-t border-slate-100 dark:border-slate-800 flex justify-end gap-3">
                  ...
                  <Link
                    ...
                    className="px-4 py-2 rounded-xl bg-[#F57C00] hover:bg-[#E65100] text-white font-bold text-xs flex items-center gap-2 shadow-xs transition-all"
                  >
